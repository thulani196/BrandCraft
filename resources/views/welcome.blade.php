...
<div id="index-banner" class="parallax-container">
        ...
        <div class="container">
            ...
            <div class="row center">
                ...
                <a id="download-button" class="waves-effect waves-light btn red darken-4 modal-trigger" href="#modal2">Request for a service</a>
                </div>
            <br><br>
...
<div id="index-banner" class="parallax-container">
    ...
    <!-- Service Request Modal Structure -->
    <div id="modal2" class="modal white darken-4">
        <div class="modal-content">
          <h4 class="center">Request for a service</h4>
          <div class="container">
            <div class="row card-panel z-depth-3">
              <form class="form" action="#" method="POST">
                  ...
                  <div class="col l6 m6 s12 input-field">
                      <input type="text" name="organization" class="validate">
                      <label for="org_name">Personal Number:</label>
                  </div>

                  <div class="col l6 m6 s12 input-field">
                      <input type="text" name="organization" class="validate">
                      <label for="org_name">Organization Number:</label>
                  </div>
